    ...
    <body>
      <form method="post" id="insert" action="./inserisci.php">
        <table border=1>
            ...
            <tr>
              <td><input type="file" id="upload" name="disegno" form="insert"></td>
              <td><input type="text" id="codice" placeholder="codice" name="codice"  form="insert" ></td>
            ...
            <tr>
              ...
              <td rowspan="3"></td>
              <td> - B - </td>
              <td><input type="text" id="componente b" placeholder="componente b" name="componente b" form="insert" ></td>
              <th>Montato_su</th>
              <th>Anteriore</th>
            </tr>
            <tr>
            ...
            <tr>
              <td> - D - </td>
              <td><input type="text" id="componente d" placeholder="componente d" name="componente d"  form="insert" ></td>
            </tr>
            <tr>
              <td colspan="3">
