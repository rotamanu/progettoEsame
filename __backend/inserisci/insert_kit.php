    ...
    <body>
      ...
      <form method="post" id="insert" action="./inserisci.php">
        <table border="5" >
            ...
            <tr>
              <td><input type="file" id="upload" placeholder="disegno" name="disegno" form="insert"/></td>
            ...
            <tr>
              <td rowspan="2"><input type="file" id="foto" placeholder="foto" name="foto"  form="insert"></td>
              <td> - C - </td>
